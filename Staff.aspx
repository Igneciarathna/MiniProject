<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Staff.aspx.cs" Inherits="Feedback_System.Staff" %>
            ...
            <div class="row vertical-center-row" style="height: 472px; margin-top: 0px; width: 1101px;">
                <div class="text-center table-center col-md-4 col-md-offset-4" style="left: -98px; top: -173px; height: 643px; width: 1406px; margin-right: 0px;">
                    <div class="center" style="height: 404px; width: 515px; margin-left: 0px; margin-top: 138px; margin-right: 0px;">
                        ...
                        <br />
                        <br />
                        <img src="\Images\Staff.jpg" /><h2 style="text-decoration: underline"><b><em>STAFF LOGIN</em></b></h2>
                        <br />
    ...
    <table style="margin: 0 auto 0 0px">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="StaffLogin" runat="server" Text="Login" OnClick="StaffLogin_Click" Width="135px" ForeColor="Black" Font-Bold="True" Font-Italic="True" Font-Names="timesnewroman" Height="41px" BackColor="Blue" style="font-size: large"/></td>
        </tr>
        <tr>
            <td></td>
            <td>
